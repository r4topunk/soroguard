...
**Observed activity (B)** — window of 40160 ledgers (~62 h, ledgers 64427432–64467591):

| Topic | Occurrences | Rate/h | Declared in spec |
|---|---|---|---|
| `update_reserves` | 14,149 | 229 | no |
| `pool_state` | 14,075 | 228 | no |
| `trade` | 14,062 | 228 | no |
| `claim_fees` | 77 | 1.25 | yes |
| `claim_reward` | 66 | 1.07 | no |
| `position_update` | 13 | 0.21 | no |
| `deposit_liquidity` | 9 | 0.15 | no |
| `withdraw_liquidity` | 4 | 0.07 | no |
| `claim_protocol_fee` | 2 | 0.03 | no |
...
| Is the baseline grounded in observation, not guesswork? | ⚠ gap | observed window: 40160 ledgers (~61.76h), 9 distinct topics; without a baseline: Elevation.1.M.1, Elevation.2.M.1, Elevation.3.M.1, Elevation.4.M.1, Elevation.5.M.1; 0 baselines with the count checked against the window. |
