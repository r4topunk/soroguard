...
**Observed activity (B)** — window of 120661 ledgers (~186 h, ledgers 64345418–64466078): no event of any topic. Absence of traffic is not a traffic profile.
...
|---|---|---|---|
| Repudiate.1 | 1 of 9 state-changing entrypoint emits no event | Whole contract (CDZY62OKIPJAB4HH44BI6PPYO4NGFQV7INDJH4KU6V6RNNSLCTUX3SCS) | Medium |
...
|---|---|---|
| Does every threat in the threat model have a monitor, or a documented reason it cannot be monitored? | ✔ ok | 2/2 threats with a monitor; 5 of 13 invocable entrypoints do not reach contract_event (`__*` reserved exports excluded, CAP-0058) — for those, monitoring through getEvents is impossible. |
...
| Is the baseline grounded in observation, not guesswork? | ⚠ gap | observed window: 120661 ledgers (~185.79h), 0 distinct topics; ⚠ gap: the window of 120661 ledgers was collected and holds no event of any topic — absence of traffic, not a traffic profile.; without a baseline: Repudiate.1.M.1; 0 baselines with the count checked against the window. |
